...
i=0 j=0 score[0] < score[0] False rank[0]=1
    ...
    j=4 score[0] < score[3] False rank[0]=1
    j=3 score[0] < score[4] True  rank[0]=2
    j=5 score[0] < score[5] False rank[0]=2(순위확정)
    
i=1 j=0 score[1] < score[0] False rank[1]=2
    j=1 score[1] < score[1] True  rank[1]=2
    j=2 score[1] < score[2] True  rank[1]=3
    j=4 score[1] < score[3] True  rank[1]=4
    j=3 score[1] < score[4] True  rank[1]=5
...
i=2 j=0 score[2] < score[0] False  rank[0]=2
    ...
    j=3 score[2] < score[4] True   rank[2]=3
